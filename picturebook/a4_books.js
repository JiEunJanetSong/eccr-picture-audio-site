window.ECCR_A4_BOOKS = [
  {
    ...
    pages: Array.from({ length: 12 }, (_, index) => ({
      title: `Page ${index + 1}`,
      image: `page-${String(index + 1).padStart(2, "0")}.png`,
      audio: [],
    })),
  },
  {
  ...
  },
  {
    ...
    pages: [
      { title: "Cover", image: "page-01.png", audio: [] },
      { title: "Book 3", image: "page-02.png", audio: [] },
      {
        title: "Fa bi",
        image: "page-03.png",
      ...
      { title: "Blank", image: "page-31.png", audio: [] },
      { title: "Credits", image: "page-32.png", audio: [] },
    ],
  },
];
